...
contract HashCreature_v1 is ERC721 {
  ...
  string public constant description =
    "HashCreatures are generated by minting transaction hash. Image svg data and token metadata is generated in ethereum, just onchain. HashCreatures have life lifespan, so image will be deteriorated when you transfer creature, and transfer is only allowed 5 times. After transfer is used up, you can burn HashCreatures to get redeemed to get new HashCreatures.";
